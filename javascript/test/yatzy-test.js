...
describe('test getSumOf', function() {
    
    it('return the sum of fours', function() {
         assert.equal(12, new Yatzy([4,4,4,5,5]).getSumOf(4));
    });
...
describe("One pair", function() {
    it("scores the sum of the highest pair", function() {
        ...
        assert.equal(0, Yatzy.score_pair([5,3,1,2,4]));
    });
});
...
describe("Two pair", function() {
    it("scores the sum of the two pairs", function() {
        ...
        assert.equal(0, Yatzy.two_pair([4,3,6,6,5]));
    });
});
